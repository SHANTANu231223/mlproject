...
def main():
    try:
        ...
        csv_file_path = "C:\\Flexon\\flexonenv\\sp500_companies.csv"
        ...
        bucket_name = "firstbucket2312"  # Specify your S3 bucket name
        file_name = "transformed_data.csv"   # Desired file name in S3
